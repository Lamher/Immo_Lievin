...
INSERT INTO addresses (`streetNumber`, `streetName`, `postalCode`, `city`, `country`) VALUES (06, 'Rue de Valmy', 62840, 'Laventie', 'France'), (29, 'Résidence la Roseraie', 62122, 'Lapugnoy', 'France'), (05, 'Rue des tests', 62000, 'Calais', 'France'), (05, 'Rue des tests', 62000, 'Calais', 'France'), (05, 'Rue des tests', 62000, 'Calais', 'France'), (05, 'Rue des tests', 62000, 'Calais', 'France'), (05, 'Rue des tests', 62000, 'Calais', 'France'), (05, 'Rue des tests', 62000, 'Calais', 'France'), (05, 'Rue des tests', 62000, 'Calais', 'France'), (05, 'Rue des tests', 62000, 'Calais', 'France');
SELECT @address := Last_insert_id();

INSERT INTO users (`name`, `surname`, `mail`, `password`, `idAddress`, `role`) VALUES ('Hermant', 'Thomas', 'cleyam@gmail.com', '$2y$10$t0wmVlkoDCXjkCcY7LcbQufSjCqcu/EEqo7TccXQOFKTqcqwLFXGK', @address, 'admin'), ('Lamorski', 'Philippe', 'philippe.lamorski@gmail.com', '$2y$10$UUStlYsDgdea98jo0bfiVO/WeZN9epLT6xvsUSu5bahU91N294yRK', @address+1, 'admin'), ('Dupont', 'Jean', 'test@gmail.com', '$2y$10$NP.M/C2qqSP.EMydAJiSseSb1sx4SZBhf13ZcdW62W1IyJKZLxCP6', @address+2, 'user');
...
INSERT INTO images (`name`, `default`, `idProperty`) VALUES ('M0000001_1.png', 1, @property), ('M0000001_2.png', 0, @property), ('M0000001_3.png', 0, @property), ('A0000001_1.png', 1, @property+1), ('A0000001_2.png', 0, @property+1), ('T0000001_1.png', 1, @property+2), ('P0000001_1.png', 1, @property+3), ('M0000002_1.png', 1, @property+4), ('M0000002_2.png', 0, @property+4), ('A0000002_1.png', 1, @property+5), ('A0000002_2.png', 0, @property+5), ('A0000002_3.png', 0, @property+5), ('M0000003_1.png', 1, @property+6);
